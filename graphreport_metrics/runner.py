import os
import argparse
from .graphreport import generate_report
from .graphreport import IGNORE_TYPES
from .graphreport import IGNORE_LIBRARIES
...
def parse_options():
    ...
    general.add_argument(
        '--logo',
        dest='logo',
        default='https://www.freepnglogos.com/uploads/cisco-png-logo/new-cisco-logo-png-1.png',
