...
def generate_report(opts):
    ...
    <div class="sidenav">
        <a> <img src="https://www.freepnglogos.com/uploads/cisco-png-logo/new-cisco-logo-png-1.png" style="height:12vh;max-width:98%;"/> </a>
    ...
    <div class="tabcontent" id="dashboard">
        ...
        <div class="d-flex flex-column flex-md-row align-items-center p-5 mb-3 bg-light
            border-bottom shadow-sm">
            <h2 class="my-0 mr-md-auto font-weight-normal"><i class="fa fa-dashboard"></i> Dashboard</h2>
        ...
        <div class="col-md-12" style="height:25px;width:auto;">
            <p class="text-muted" style="text-align:center;font-size:9px">
                <a href="https://github.com">Python-Library </a>
            </p>
        </div>
        </div>
